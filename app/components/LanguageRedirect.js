...
const LanguageRedirect = ({ defaultLocale }) => {
    ...
    useEffect(() => {
        ...
        const locales = ['de-DE', 'arg', 'es-AR', 'en-AU','pt-BR', 'en-CA',
            'en-CO', 'es-ES', 'et-EE', 'en-US', 'fr-FR', 'en-IE', 'it-IT', 'es-MX', 'en-NZ', 'nl-NL',
            'pl-PL', 'en-GB', 'ru-RU', 'ar-AE','zh-CN', 'de', 'es', 'en', 'fr', 'ru', 'ar'];
