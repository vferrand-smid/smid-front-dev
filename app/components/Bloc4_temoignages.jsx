...
export default function Bloc4Temoignages({ translations, isArabic }) {
    useEffect(() => {
    ...
    useEffect(() => {
        const initializeCarousel = () => {
            ...
            MarrowBtns.forEach((btn) => {
                btn.addEventListener('click', () => {
                    Mcarousel.scrollLeft += btn.id == 'left' ? -MfirstCardWidth() : MfirstCardWidth();
            ...
            const MinfiniteScroll = () => {
                ...
                else if (Math.ceil(Mcarousel.scrollLeft) === Mcarousel.scrollWidth - Mcarousel.offsetWidth) {
                    Mcarousel.classList.add('no-transition');
    ...
    useEffect(() => {
        const initializeCarousel = () => {
            ...
            const PinfiniteScroll = () => {
                ...
                else if (Math.ceil(Pcarousel.scrollLeft) === Pcarousel.scrollWidth - Pcarousel.offsetWidth) {
                    Pcarousel.classList.add('no-transition');
    ...
    return (
        <div className={`${styles.kalTestimonials} ${isArabic && 'kal-testimonials-arabic'}`} style={{ textAlign: isArabic && 'right' }}>
            <h2 className='mb-10 max-md:!text-center'>
                {translations['titre_bloc4_1']}
                <span className='highlight'>{translations['titre_bloc4_span']}</span>
                {translations['titre_bloc4_2']}
            </h2>
            ...
            <div className='kal-testimonials-carousel-wrapper'>
                ...
                <div className='kal-testimonials-carousel'>
                    {translations['temoignages']?.map((temoignage, index) => (
            ...
            {translations['media'].some((mediaItem) => mediaItem.img && mediaItem.text) && (
                <div className='kal-testimonials-media-wrapper' style={{ flexDirection: isArabic && 'row-reverse' }}>
                    <h3 className='text-2xl max-md:!text-center'>{translations['nos_medias']}</h3>
                    ...
                    <div className='kal-testimonials-media'>
                        {translations['media']?.map(
                            (mediaItem, index) =>
                                mediaItem.img &&
                                mediaItem.text && ( // Affiche uniquement si les deux champs sont remplis
                                    <section key={index}>
                                        <Image width={500} height={500} src={mediaItem.img} alt={mediaItem.text} />
                                        <p>{mediaItem.text}</p>
                                    </section>
                                )
                        )}
            ...
            <div className='kal-testimonials-partner-wrapper'>
                <h3 className='text-2xl max-md:!text-center'> {translations['nos_partenaires']}</h3>
                ...
                <div className='kal-testimonials-partner'>
                    {translations['partenaires']?.map((partenaire, index) => (
