        ...
        <div id="duplicator-pro-help-footer">
            ...
            <div class="duplicator-pro-help-footer-block">
                ...
                <p>
                    ...
                    <?php printf(
                        esc_html_x(
                            'If reporting a bug, remember to include the %1$sDiagnostic Data%2$s file to speed-up the debugging process.',
                            '1: opening anchor tag, 2: closing anchor tag',
                            'duplicator-pro'
                        ),
                        '<a href="' . esc_url(ServicesTools::getSupportToolkitDownloadUrl()) . '">',
                        '</a>'
                    ); ?>
                </p>
                <a 
