        ...
        DupPro.Pack.setScanStatus = function (status)
        {
            ...
            switch (status) {
                case false :
                    ...
                    break;
                case 'Warn' :
                    result = '<div class="badge badge-warn"><?php echo esc_js(__('Notice', 'duplicator-pro')) ?></div>';
                    break;
                case true :
                    result = '<div class="scan-good"><i class="fa fa-check"></i></div>';
                    break;
                case 'Good' :
                    result = '<div class="badge badge-pass"><?php echo esc_js(__('Good', 'duplicator-pro')) ?></div>';
                    break;
                default :
                    result = '<?php echo esc_js(__('unable to read', 'duplicator-pro')) ?>';
            }
            return result;
        }
